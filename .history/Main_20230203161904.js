...
function Main() {
  ...
  if (!isMobile) {
    ...
    heightRatio = 0.65;
    var deg = 0;
    document.body.style.webkitTransform = 'rotate(0 deg)'; 
    document.body.style.mozTransform    = 'rotate(0 deg)'; 
    document.body.style.msTransform     = 'rotate(0 deg)'; 
    document.body.style.oTransform      = 'rotate(0 deg)'; 
