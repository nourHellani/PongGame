...
function unlock (){
  ...
  else if (document.mozRequestFullScreen){de.mozRequestFullScreen();}
  else if (document.webkitRequestFullScreen){de.webkitRequestFullScreen();}
  else if (document.msRequestFullScreen){de.msRequestFullScreen();}
