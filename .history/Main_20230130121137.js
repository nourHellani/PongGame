...
function Main()
{
	...
	SoundJS.addBatch([
		{name:'hit', src:'assets/mp3/hit.mp3', instances:1},
		{name:'playerScore', src:'assets/mp3/playerScore.mp3', instances:1},
		{name:'enemyScore', src:'assets/mp3/enemyScore.mp3', instances:1},
		{name:'wall', src:'assets/mp3/wall.mp3', instances:1}]);
  		
  	/* Load GFX */
  		
  	bgImg.src = 'assets/mp3/bg.png';
  	bgImg.name = 'bg';
